...
For example, let's take the date 02-08-2024. Here, the date is 02, month is 08 and year is 2024. Concatinating them as mentioned above, we get x = 2082024. As x is divisible by 4, we call this date a lucky date.

Debug the given function findPrimeDates() to find the correct lucky dates from the given input.
